...
Dit noemen we de verzameling *SSI services* en zijn via [live.ledgr.nl](https://live.ledgr.nl/docs) te benaderen, in feite een API voor het doen van transacties op de (private) blockchain van [Dock](dock.io). De code van de SSI services staat [hier](https://gitlab.com/ovrhd/service.ledger.nl).
